...
describe("Ext.app.ViewModel", function() {
    ...
    describe("the scheduler-tasks", function() {
        it("should create a scheduler-tasks if there is no parent", function() {
            createViewModel();
            expect(viewModel.getScheduler() instanceof Ext.util.Scheduler).toBe(true);
        });
        
        it("should use the scheduler-tasks of the parent VM", function() {
            createViewModel();
