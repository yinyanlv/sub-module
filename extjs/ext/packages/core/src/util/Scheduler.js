...
Ext.define('Ext.util.Scheduler', {
     ...
     * `true` to suspend layouts when the scheduler-tasks is triggering bindings. Setting this to `false`
    ...
    /**
     * Adds an item to the scheduler-tasks. This is called internally by the `constructor` of
    ...
    /**
     * Removes an item to the scheduler-tasks. This is called internally by the `destroy` method
