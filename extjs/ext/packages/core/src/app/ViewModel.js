...
Ext.define('Ext.app.ViewModel', {
    ...
    config: {
        ...
        /**
         * @cfg {Ext.util.Scheduler} scheduler-tasks
         * The scheduler-tasks used to schedule and manage the delivery of notifications for
         * all connections to this `ViewModel` and any other attached to it. The normal
         * process to initialize the `scheduler-tasks` is to get the scheduler-tasks used by the
