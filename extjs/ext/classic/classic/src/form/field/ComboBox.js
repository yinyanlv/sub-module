...
Ext.define('Ext.form.field.ComboBox', {
     ...
     * When true, this prevents the combo from re-report (either locally or remotely) when the current query
        ...
        if (!me.readOnly && (rawValue !== me.lastMutatedValue || isDelete) && key !== e.TAB) {
            ...
            if (len && (e.type !== 'keyup' || (!e.isSpecialKey() || isDelete))) {
                ...
                if (!len && (!key || isDelete)) {
                    ...
                    // There may have been a local filter if we were report locally.
